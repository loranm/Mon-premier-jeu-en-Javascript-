        ...
        this.gravity = function() {
            if (this.dx >= this.floor.x1 && this.dx <= this.floor.x2) {
                ...
                if (this.dy <= this.maxJump) {
                    console.log('je peux sauter')
                    var dir = 1
                }

                if (this.dy>= this.floor.bottom) {
                    console.log('je ne peux pas sauter')
                    var dir = 0;
                }
                ...
                if (stage[i]) {
                    if (this.dx < stage[i].dx + stage[i].dw - 2 * this.hitBoxAdj &&
                        ...
                        this.dh + this.dy > stage[i].dy + this.hitBoxAdj) {
                            this.collision = true;
                                if(stage[i].danger){console.log('danger')};
                                if(stage[i].platform){
                                    this.currentPlatform = stage[i].platform;
                                    this.vsPlatform(this.currentPlatform)
                                };
                                if(stage[i].bonus){console.log('bonus')};
                    }
                }
            };
        };

window.document.addEventListener('DOMContentLoaded', function() {
  ...
  *****************************************************************************/
  ...
  function background() {
    ...
    var displayCountDown = parseInt((7260 - requestId) / 60) + ' secondes  avant la fin du jeu';
    var countDownTextSize = ctx.measureText(displayCountDown)
    ctx.fillStyle = "#c5d8cb"
    ctx.fillText(displayCountDown, 10, 90);
    ctx.strokeText(displayCountDown, 10, 90);
